trigger ddFieldTrigger on Data_Dictionary_Field__c (after update) {
    ...
    List<String> nativeFieldNames = new List<String>{'page_layouts__c', 'permission_set_groups_edit__c', 'permission_set_groups_read__c', 'permission_sets_edit__c', 'permission_sets_read__c', 'profiles_edit__c', 'profiles_read__c', 'picklist_values_dependencies__c', 'picklist_values_by_record_type__c'};
